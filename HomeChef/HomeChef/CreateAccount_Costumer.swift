...
import FirebaseAuth
struct CreateAccount_Costumer: View {
    @State var userName = ""
    @State var emaill = ""
    @State var password = ""
        ...
        NavigationView{
            VStack{
                ...
                VStack(alignment: .center, spacing: 16){
                    ...
                    NavigationLink("Go", destination: Home()
...
struct CreateAccount_Costumer_Previews: PreviewProvider {
    static var previews: some View {
        CreateAccount_Costumer()
    }
}
